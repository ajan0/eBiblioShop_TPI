...
class BookSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('books')->insert([
            ...
            'published_at' => Carbon::create(2022,5,1),
            'user_id' => $users->random(),
            'category_id' => 3,
            'created_at' => now(),
        ]);
        ...
        DB::table('books')->insert([
            ...
            'published_at' => Carbon::create(2005,10,1),
            'user_id' => $users->random(),
            'category_id' => 4,
            'created_at' => now(),
        ]);
        ...
        DB::table('books')->insert([
            ...
            'published_at' => Carbon::create(2017,8,1),
            'user_id' => $users->random(),
            'category_id' => 5,
            'created_at' => now(),
        ]);
        ...
        DB::table('books')->insert([
            ...
            'published_at' => Carbon::create(2019,6,1),
            'user_id' => $users->random(),
            'category_id' => 6,
            'created_at' => now(),
        ]);
        ...
        DB::table('books')->insert([
            ...
            'published_at' => Carbon::create(2001,2,1),
            'user_id' => $users->random(),
            'category_id' => 7,
            'created_at' => now(),
        ]);
        ...
        DB::table('books')->insert([
            ...
            'published_at' => Carbon::create(2022,3,1),
            'user_id' => $users->random(),
            'category_id' => 8,
            'created_at' => now(),
        ]);
